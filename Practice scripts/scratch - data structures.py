...
print(list_1[2:])           # slice from Alice
print(list_1[1::2])         # interval containing 2 & Alice
print(type(list_1))
...
dict_1.pop(2)               # removes third
print(dict_1)

# sets (can add & remove values but not change)
...
# tuples (cannot add, remove or change values)
tup_1 = ('a', 'b', 'd', 'c', 'e')
print(tup_1)
print(tup_1[2])  # d
